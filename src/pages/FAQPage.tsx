    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-border bg-white text-sm focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent transition-colors"
        />
      </div>
